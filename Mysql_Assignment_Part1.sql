...
insert into suppliers values (1,'Beauty Suppliers','Germany');
   insert into suppliers values (2, 'Home Suppliers','China');

insert into product values(100,'Cetaphil', 'A Moisturiser for extremely dry skin', 1),
   (200,'Bed Lamp', ' A lamp at the side or head of a bed. ',2);

 insert into stock values (1,100,23),(2,200,5);
...
alter table supplier modify supplier_name varchar(20) unique not null;
...
CREATE UNIQUE INDEX emp_id ON emp(emp_id);
